                ...
                <div className='space-y-3'>
                  ...
                  <div className='space-y-5 text-justify'>
                    <p>
                      ...
                      soccer academy at [academy name]! Get ready for a season
                      of fun, skill-building, and teamwork as [ward&apos;s name]
                      hones their footwork, builds confidence, and makes lasting
                      memories with our passionate coaches and fellow future
                      stars.
                    </p>
                    <p>
                      Complete your registration and secure your spot on the
                      team!
                    </p>
                    <p>
                      Just click the button below to finalize the process and
                      kick off this exciting journey:
                    </p>
